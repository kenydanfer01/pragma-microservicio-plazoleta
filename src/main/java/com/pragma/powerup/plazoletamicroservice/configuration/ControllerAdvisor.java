...
public class ControllerAdvisor {
    ...
    @ExceptionHandler(OwnerAlreadyAssignedException.class)
    public ResponseEntity<Map<String, String>> handleOwnerAlreadyAssignedException(
            OwnerAlreadyAssignedException ownerAlreadyAssignedException) {
        return ResponseEntity.status(HttpStatus.NOT_FOUND)
                .body(Collections.singletonMap(RESPONSE_ERROR_MESSAGE_KEY, OWNER_ALREADY_ASSIGNERD_MESSAGE));
    }
